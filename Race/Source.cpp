...
CSourceLight LightTargets;          // источник дл€ мишеней (по задаче SCSG-6)
CShader ShaderPhong;                // шейдер дл€ мишеней (по задаче SCSG-6)
...
// ћ»Ў≈Ќ»
const float TARGET_INTERVAL = 10.0f;  //рассто€ние между мишен€ми
